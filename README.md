<!DOCTYPE HTML>
<html>
<head><title>Hai Ayu</title>
<!-- Created By L3M4R1 -->
<script>alert ('hbd')
alert ('HappyBirthday Ayu')</script>
...
tb5_messages[0] = "Hay Ayu Rahayu";
tb5_messages[1] = "Selamat Ulang Tahun";
tb5_messages[2] = "Semoga Panjang Umur dan sehat selalu";
tb5_messages[3] = "Cepat Nikah,Cepat lulus";
